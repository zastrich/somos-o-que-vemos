...
var textStrings_PTBR = {
	// Act 1
	"niceHat": "É MODA! BELO CHAPÉU",
	"outtaHere": "saiam daqui",
	"getARoom": "NÃO FAÇAM ISSO EM PÚBLICO",
	"notCoolAnymore": "Adeus a moda dos Chapéus",
	"tvOnTv": "A TV... NA TV!",
	"cricky": "CRI! CRI!",
	"tooManyCrickets": "ainda não parece uma infestação",
	"normalPeep": "pessoas normais",
	"normalPeeps": "mais pessoas normais",
	"wowNothing": "UAU! NADA ACONTECE POR AQUI",

	// Act 2
	"crazySquareAttacks": "UM CABEÇA QUADRADA ESTÁ ATACANDO",
	"justMissed": "chegou um pouco atrasado na notícia",
	"somethingInteresting": "(você precisa flagrar algo interessante)",
	"whoIsScreaming": "(tente dar um flagrante no momento do ataque)",
	"circleFearsSquares": "CABEÇAS REDONDAS TEMEM OS QUADRADOS",
	"whoScaresThem": "(*de quem* eles estão com medo?)",
	"squaresSnubCircles": "CABEÇAS QUADRADA AFRONTAM OS REDONDOS",
	"everyoneHates": "TODO MUNDO SE ODEIA!!",
	...
	// Act 3
	"ellipsis": ". . .",
	"coolNoMore": "chapéus saíram de moda, não tá sabendo?",
	...
	"warning": "ATENÇÃO:\nse você é impactado por:\nver pessoas esnobes e assassinatos em massa\naconselhamos não continuar.",

	// (cam-instructions.png) Camera Instructions
	"pointAndClick": "APONTE & CLIQUE",

	// (chyron3.png)
	"chyronNothing": "UAU! *NADA* ACONTECE",
	...
	// (credits0002.png)
	"manyThanks": "muitos agradecimentos aos testers:",

	// (credits000[3,4,5,6].png)
	"patreonSupporters": "e aos meus apoiadores do patreon:",

	// (credits0007.png)
	"lastButNotLeast": "e por último mais não menos importante,",

	// (credits0008.png)
	"thankYouForPlaying": "agradeço a VOCÊ por ter jogado.",
	...
	"replayButton": "reiniciar o jogo",

	// (logo.png) Post Credits
	"logoWBWWB": "COMPARTILHE SUA DOR:",
	...
	// (quote0002.png)
	"WBWWB": "Somos o que Vemos",
	"WSOTATOTSU": '"Moldamos nossas ferramentas e então nossas ferramentas nos moldam."',

	// (quote0003.png)
	"MarshallMcLuhan": "Marshall McLuhan",

	// (quote0004.png)
	"misatrributed": "(atribuição errada)",
};
