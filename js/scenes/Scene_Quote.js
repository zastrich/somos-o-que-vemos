...
function Scene_Quote(){
    ...
    var q2TitleText = new PIXI.Text(textStrings["WBWWB"] + "\n", {font:"65px RobotoCondensed", fill:"#FFFFFF", align:"center"});
    ...
    var q2QuoteText = new PIXI.Text(textStrings["WSOTATOTSU"] + "\n", {font:fontsize+"px RobotoCondensed", fill:"#FFFFFF", align:"center"});
    ...
    var q3Name = new PIXI.Text(textStrings["MarshallMcLuhan"], {font:"33px RobotoCondensed", fill:"#FFFFFF", align:"center"});
    q3Name.anchor.x = 0.5;
    q3Name.anchor.y = 0.5;
